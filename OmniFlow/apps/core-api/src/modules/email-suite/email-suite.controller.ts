...
@ApiTags('email-suite/domains')
@ApiBearerAuth()
@UseGuards(JwtAuthGuard)
@Controller('email-suite/domains')
export class EmailSuiteController {
  constructor(private readonly service: EmailSuiteService) {}

  @Get()
  @ApiOperation({ summary: 'List all email-suite/domains' })
